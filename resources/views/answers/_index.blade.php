                ...
                @foreach ($answers as $answer)
                    <div class="media">
                        <div class="d-fex flex-column vote-controls">
                                <a title="This answerr is useful"  onclick="event.preventDefault(); document.getElementById('up-vote-answer-{{ $answer->id }}').submit();" class="vote-up {{ Auth::guest() ? 'off' : '' }}">
                                ...
                                <a title="This question is not useful" onclick="event.preventDefault(); document.getElementById('down-vote-answer-{{ $answer->id }}').submit();" class="vote-down {{ Auth::guest() ? 'off' : '' }}">
